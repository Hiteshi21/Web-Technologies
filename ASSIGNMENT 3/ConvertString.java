...
public class ConvertString {
    ...
    static void DisplayWay(String s1, String s2, ArrayList<String> changes) {

        // Function to print all the ways
        displayChanges(s1, s2, new ArrayList<String>());
    ...
    static void displayChanges(String s1, String s2, ArrayList<String> changes) {
            ...
            if (s1.charAt(i - 1) == s2.charAt(j - 1)) {
                ...
                if (dp[i][j] == dp[i - 1][j] + 1) {
                    if (if1 == false) {
                        ...
                        displayChanges(s1.substring(0, i),
                ...
                if (dp[i][j] == dp[i][j - 1] + 1) {
                    if (if1 == false && if2 == false) {
                        ...
                        displayChanges(s1.substring(0, i + 1),
    ...
    public static void main(String[] args) throws Exception {
        ...
        DisplayWay(s1, s2, new ArrayList<String>());
